...
output_base = "F:/vertical_slice/scan_00081/full_reconstruction/"
...
crop = (1000, 1500, 900, 900)  # (crop_top, crop_bottom, crop_left, crop_right)
...
print(f"\nCenter-of-rotation is: {center}\n")
print("Apply preprocessing methods to sinograms")
